# Architects Chatbot - RAG-based AI Assistant

Chatbot thông minh sử dụng Retrieval-Augmented Generation (RAG) để trả lời câu hỏi về công ty Architects, dự án kiến trúc, nội thất và tin tức.
...
- data: https://drive.google.com/file/d/13ihR34bYv4A4pkdpaUnbjJI9oPEBdnLz/view?usp=drive_link
## Cài đặt nhanh

### 1. Clone repository

```bash
git clone https://github.com/DucwTran/RetrievalChatBot.git
cd RetrievalChatBot
```
